...
import 'package:concierge/widgets/divider_with_text_widget.dart';
...
//  Timer _throttle;
  ...
  Future<String> getLocationPhotoRef(placeId) async {
    String placeImgRequest =
        'https://maps.googleapis.com/maps/api/place/details/json?place_id=$placeId&fields=photo,geometry&key=$PLACES_API_KEY&sessiontoken=$_sessionToken';
